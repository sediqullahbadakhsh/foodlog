...
class ModelsTest < ApplicationSystemTestCase
  ...
  test "should create model" do
    ...
    fill_in "Entry", with: @model.Entry
    fill_in "Calories", with: @model.calories
    fill_in "Carbohydrates", with: @model.carbohydrates
    fill_in "Fats", with: @model.fats
    fill_in "Meal type", with: @model.meal_type
    fill_in "Proteins", with: @model.proteins
